...
const Skeleton: React.FC<SkeletonProps> = ({ variant = 'vertical' }) => {
  if (variant === 'horizontal') {
    return (
      <div className="flex flex-col sm:flex-row gap-5 bg-white p-4 rounded-2xl border border-slate-100 animate-pulse">
        <div className="sm:w-5/12 bg-slate-200 rounded-xl h-48 sm:h-auto"></div>
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-slate-100 animate-pulse flex flex-col h-full">
      ...
      <div className="p-5 space-y-4 flex-grow">
        ...
        <div className="pt-4 border-t border-slate-50 mt-auto flex items-center gap-2">
